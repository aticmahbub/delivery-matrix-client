         ...
         { 
            ...
            <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10"><svg aria-hidden="true"
              ...
              <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                <div>
                  <div className="font-display text-base text-slate-900">{item?.revUserName}</div>
                </div>
                <div className="overflow-hidden rounded-full bg-slate-50">
                  <img alt="" className="h-14 w-14 object-cover"  src={item?.revPhotoURL}/> .
                </div>
              </figcaption>
            </figure>
          </li>)}
...
<div classNameName="grid grid-cols-2 gap-4">
{
    specificReview.map(item=>
        <div  key={item._id} classNameName=" card w-96 bg-base-100 shadow-xl image-full">
    <figure><img src={item?.revPhotoURL} alt="Shoes" /></figure>
    <div classNameName="card-body">
        <h2 classNameName="card-title">{item?.revUserName}</h2>
